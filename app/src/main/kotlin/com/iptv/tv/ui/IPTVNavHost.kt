...
sealed class Screen(val route: String) {
    ...
    data object Player :
        Screen("player/{streamId}/{streamUrl}/{streamName}/{streamType}/{startPosition}/{seriesId}/{posterUrl}/{episodeSeason}/{episodeNum}/{episodeTitle}") {
        fun route(
            streamId: String,
            encodedUrl: String,
            encodedName: String,
...
fun IPTVNavHost() {
    ...
    NavHost(
        ...
        composable(
            ...
            val streamType = try {
                ContentType.valueOf(streamTypeStr)
            } catch (_: Exception) {
                ContentType.LIVE
            }
